  ...
  return (
    <div className="w-screen  lg:h-screen bg-feature  bg-[length:100%_80%] bg-no-repeat">
      <div className="container mx-auto justify-start text-left">
        <h1 className="text-[#00A077] text-md font-bold text-sm lg:text-xl ml-2 lg:ml-0 mb-4 lg:mb-10">
          FEATURES
        </h1>
        <h1 className="font-medium text-3xl lg:text-5xl leading-normal ml-2 lg:ml-0 text-[#3B3E43] mb-5">
