...
const Brands = () => {
  return (
    <div className=" py-[2rem] lg:py-[8rem] flex flex-col items-center justify-center">
      <h1 className="text-[#00A077] mb-4 text-sm md:text-base">BRANDS</h1>
      <h1 className="text-xl md:text-2xl lg:text-4xl text-center font-medium leading-smooth mb-4 text-[#3B3E43]">
      ...
      <p className="text-[#424A4D] text-center text-sm md:text-base lg:text-lg mt-6 lg:mt-0">
